package com.ff.alipayment.config;
...
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	public static String app_id;// = "2016101400683608";
    ...
    public   void setApp_private_key(String app_private_key) {
        AlipayConfig.merchant_private_key = app_private_key;
    }
    ...
    public   void setReturn_url(String return_payment_url) {
        AlipayConfig.return_url = return_payment_url;
    }
    @Value("${notify_payment_url}")
    public   void setNotify_url(String notify_payment_url) {
        AlipayConfig.notify_url = notify_payment_url;
    }
	...
	// 日志地址
	public static String log_path = "C:\\Users\\方云聪\\Desktop\\alipaylog";
